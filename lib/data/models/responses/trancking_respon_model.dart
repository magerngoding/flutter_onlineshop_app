...
class TrackingResponModel {
  ...
  factory TrackingResponModel.fromJson(String str) =>
      TrackingResponModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TrackingResponModel.fromMap(Map<String, dynamic> json) =>
      TrackingResponModel(
