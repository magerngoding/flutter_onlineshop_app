...
class OrderDetailResponModel {
  final OrderDetail? order;

  OrderDetailResponModel({
    this.order,
  });

  factory OrderDetailResponModel.fromJson(String str) =>
      OrderDetailResponModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OrderDetailResponModel.fromMap(Map<String, dynamic> json) =>
      OrderDetailResponModel(
        order:
